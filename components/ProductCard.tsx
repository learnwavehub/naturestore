  ...
  return (
    ...
    >
      ...
      <Link
        ...
        className="relative block overflow-hidden rounded-3xl border border-slate-200/50 dark:border-slate-700/50 bg-white dark:bg-slate-900 shadow-lg hover:shadow-2xl transition-all duration-500"
      >
        {/* Discount Badge */}
        {hasDiscount && (
        ...
        {/* Floating Heart */}
        <div className="absolute top-3 right-3 z-30 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md rounded-full p-2 shadow-lg">
          <HeartFavorite
            product={product}
        ...
        >
          <Link
            href={`/products/${product._id}`}
            className="flex items-center gap-2 bg-white/95 text-slate-900 text-xs font-semibold px-4 py-2.5 rounded-full shadow-lg hover:scale-105 transition"
          >
            <Eye size={14} />
            Quick View
          </Link>
